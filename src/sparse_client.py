...
# np.save("400_400_400_0.3", input_var)
...
start_time = t.time()
output = vc.binary_closing(input_var,make_float32=False,no_of_blocks=4,fakeghost=1,structure=structure, iterations=1, output=None, origin=0, mask=None, border_value=0, brute_force=False)
...
start_time = t.time()
output = vc.binary_opening(input_var, make_float32=False,structure=structure, no_of_blocks=4,fakeghost=1,iterations=1, output=None, origin=0, mask=None, border_value=0, brute_force=False)
