...
class WidgetTestCase(unittest.TestCase):
	...
	def test_sparse_operation(self):
		self.__test_blocks4_7(input_svar)
		self.__test_fakeghost1_2_3_4_10(input_svar)
		self.__test_nothing_make_float32_True(input_svar)
		
	def test_dense_operation(self):
		self.__test_blocks4_7(input_dvar)
		self.__test_fakeghost1_2_3_4_10(input_dvar)
		self.__test_nothing_make_float32_True(input_dvar)
		
	def __test_blocks4_7(self,input_var):
		temp = [4,7]
		for i in temp:
			PL[0] = i				
	...
	def __test_fakeghost1_2_3_4_10(self,input_var):
		temp = [1,2,3,4,10]
		for i in temp:
			PL[1] = i				
			self.__test_binary_dilation_operation(input_var)
	...
	def __test_nothing_make_float32_True(self,input_var):
		...
		self.assertTrue((v_output.dtype=="float32").all(), msg="data type is not converted to float32")	
	...
	def __test_binary_hit_or_miss_operation(self,input_var):		
		...
		start_time = t.time()
		v_output = vc.binary_hit_or_miss(input_var,structure=structure,no_of_blocks=PL[0],fakeghost=PL[1],make_float32=False)
		print("binary_hit_or_miss Voxel testing time taken: ",(t.time() - start_time)," sec")
		#print("\n binary_hit_or_miss Default testing...")
		start_time = t.time()
		d_output = ndimage.binary_hit_or_miss(input_var,structure=structure)
